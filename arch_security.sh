    ...
    rm /etc/systemd/system/macchange.service 
    rm /etc/systemd/system/multi-user.target.wants/dnscrypt-proxy*
    rm /etc/firewall-start
    rm /etc/macchange
    rm /etc/dnscrypt-proxy -R
    ...
    # ArchLinux
    pacman -Sy iptables tor torsocks
...
# -----------------------------------------------------------------------------------------------------------------------
    ...
    pacman -Sy tor torsocks
    syatemctl enable tor
    systemctl start tor
